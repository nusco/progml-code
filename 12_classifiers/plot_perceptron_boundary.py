...
plt.add_subplot().axes.set_xlabel("Input A", fontsize=20)
plt.add_subplot().axes.set_ylabel("Input B", fontsize=20)
plt.add_subplot().axes.xaxis.set_ticklabels([])
plt.add_subplot().axes.yaxis.set_ticklabels([])
plt.show()
